...
COMMENT ON TABLE uzytkownicy IS 'Użytkownicy prywatni aplikacji Recenz.io';
...
COMMENT ON VIEW moje_recenzje_piwa IS 'Perspektywa umożliwiająca użytkownikowi przejrzenie (tylko) własnych ocen piw.';
